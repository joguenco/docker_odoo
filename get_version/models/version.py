...
class Version(models.Model):
    ...
    version_database = fields.Char(compute="_compute_version_database")
    version_python = fields.Char(compute="_compute_version_python")
    version_os = fields.Char(compute="_compute_version_os")
    version_odoo = fields.Char(compute="_compute_version_odoo")
